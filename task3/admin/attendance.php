    ...
    <div class="row p-0">
      <div class="col-md-1 sidebar p-0">
        ...
        <ul class="sidebar-links text-center">
          ...
          <li class="items active" title="Attendance" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <nav class="navbar shadow-blue navbar shadow-blue-expand-lg bg-white">
          <div class="container-fluid px-5 mx-2" style="width: 100%;">
            <div class="row" style="width: 100%;">
              <div class="col-6">
                <div class="heading-text">Attendance <span>Management</span></div>
              </div>
        ...
        <div class="container mt-4">
          ...
          <div class="row">
            ...
            foreach ($studentData as $data) {
              ...
              <div class="col-md-4 mt-3">
                <div class="card shadow-blue">
                  <div class="text-center">
                    <p class="mb-0 mt-3" style="font-weight: 500;">' . $data['name'] . '</p>
                    <p class="text-muted">Rollnumber: ' . $data['rollnumber'] . '</p>
                    <form action="../scripts/server.php" method="POST" class="my-3 px-4">
                      <div class="row">
                        <div class="col-6 text-start my-auto">
                          <label style="font-weight: 500;" for="daysattended">Days Attended</label>
                          <br><br>
                          <label style="font-weight: 500;" for="daysattended">Total Days</label>
                        </div>
                        <div class="col-6">
                          <input type="number" min="0" max="365" value="' . $data['daysattended'] . '" name="da" style="padding-left: 10px; width: 170px;" id="daysattended">
                          <br><br>
                          <input type="number" disabled min="0" value="365" maximum="365" name="da" style="padding-left: 10px; width: 170px;" id="daysattended">
                        </div>
                      </div>
                      <div class="row mt-4">
                        <div class="col-6 ps-0">
                          <input type="hidden" name="id" value="' . $data['id'] . '">
                          <button type="submit" name="updateAttendance" class="btn btn-primary btn-sm">Update Record</button>
                        </div>
                        <div class="col-6 my-auto">
                          <div class="badge py-1 border ';
              if (round($data['attendance'], 1) > 70) {
                echo "bg-success border-success ";
              ...
              echo '">' . round($data['attendance'], 1) . '%</div>
                        </div>
                      </div>
