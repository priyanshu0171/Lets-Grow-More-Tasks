    ...
    <div class="row p-0">
      ...
      <div class="col-md-11 px-0 main-content">
        ...
        <?php
                    ...
                    ?>
          <div class="p-4 card col-6 shadow-blue">
            <h4 style="font-weight: 500;">Update Scores</h4>
            <div class="mt-3 col-6">
              <form action="update.result.php" method="POST">
                <label for="rollnumber" class="form-label">Roll Number</label>
                <select class="form-select" name="rollnumber" id="rollnumber" required>
                  <?php
                  foreach ($studentData as $data) {
                    echo '<option value="' . $data['rollnumber'] . '">' . $data['rollnumber'] . ' : ' . $data['name'] . '</option>';
                  }
                  ?>
                </select>
                <button class="btn btn-primary mt-3" type="submit" name="addScore">Add Scores</button>
              </form>
