      ...
      <div class="row p-0">
        <div class="col-md-1 sidebar p-0">
          ...
          <ul class="sidebar-links text-center">
            <li class="items active" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
              <a href="./index.php">
        ...
        <div class="col-md-11 px-0 main-content">
          <nav class="navbar navbar-expand-lg bg-white shadow-blue">
            <div class="container-fluid px-5 mx-2" style="width: 100%;">
              <div class="row" style="width: 100%;">
                <div class="col-6">
                  <div class="heading-text">Dash<span>board</span></div>
                </div>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li>
                        <form action="../scripts/server.php" method="POST">
                          <button class="dropdown-item" type="submit" name="statusChange">Change Status</button>
                        </form>
                      </li>
                    </ul>
                  </div>
          ...
          <div class="container-fluid px-5 mt-5">
            <div class="row">
              <div class="col-md-4 pe-2">
                <div class="card mx-auto shadow-blue" style="width: 344px;">
                  <div class="p-3">
                    <div class="row">
                      <div class="col-6 text-center">
                        <p class="text-s my-1 fw-bold">Students</p>
                        <h5 class="text-primary"><?php echo sizeof((array)$studentData); ?></h5>
                      </div>
                      <div class="text-center col-6">
                        <svg style="opacity: 20%;" xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none" stroke="#364f6b" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text">
              ...
              <div class="col-md-4">
                <div class="card mx-auto shadow-blue" style="width: 344px;">
                  <div class="p-3">
                    <div class="row">
                      <div class="col-6 text-center">
                        <p class="text-p my-1 fw-bold">Passed</p>
                        <h5 class="text-primary">
                          <?php
                          $count = 0;
                          foreach ((array)$studentData as $data) {
                            if ($data['result'] == 1) {
                              $count++;
                            }
                          }
              ...
              <div class="col-md-4">
                <div class="card mx-auto shadow-blue" style="width: 344px;">
                  <div class="p-3">
                    <div class="row">
                      <div class="col-6 text-center">
                        <p class="text-primary my-1 fw-bold">Failed</p>
                        <h5 class="text-primary">
                          <?php
                          $count = 0;
                          foreach ((array)$studentData as $data) {
            ...
            <div class="row mt-5 pt-5">
              ...
              <div class="col-6 px-5 mx-5">
                <svg id="fab53ecb-c04a-44eb-8d92-23f87bdb6c81" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="500" height="400" viewBox="0 0 942.54724 631.43903">
                  ...
                  <path d="M679.33353,309.77539a6.25343,6.25343,0,1,1-6.18294-6.32313A6.26054,6.26054,0,0,1,679.33353,309.77539Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  ...
                  <path d="M711.03754,381.30414h-42.9283a4.57772,4.57772,0,1,1,0-9.15544h42.9283a4.57772,4.57772,0,0,1,0,9.15544Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  ...
                  <path d="M727.24826,403.819h-59.139a4.57772,4.57772,0,1,1,0-9.15544h59.139a4.57772,4.57772,0,0,1,0,9.15544Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  ...
                  <path d="M692.125,426.33393H668.10924a4.57772,4.57772,0,1,1,0-9.15543H692.125a4.57772,4.57772,0,0,1,0,9.15543Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  ...
                  <path d="M307.88363,395.06909H282.81508a2.56336,2.56336,0,0,1-2.56051-2.5603V357.95166a2.56337,2.56337,0,0,1,2.56051-2.5603h25.06855a2.56337,2.56337,0,0,1,2.56051,2.5603v34.55713A2.56336,2.56336,0,0,1,307.88363,395.06909Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  <path d="M353.59927,395.06909H328.53072a2.56336,2.56336,0,0,1-2.56051-2.5603V325.17441a2.56336,2.56336,0,0,1,2.56051-2.5603h25.06855a2.56336,2.56336,0,0,1,2.56051,2.5603v67.33438A2.56336,2.56336,0,0,1,353.59927,395.06909Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  <path d="M399.31491,395.06909H374.24636a2.56337,2.56337,0,0,1-2.56051-2.5603V357.95166a2.56337,2.56337,0,0,1,2.56051-2.5603h25.06855a2.56337,2.56337,0,0,1,2.56052,2.5603v34.55713A2.56337,2.56337,0,0,1,399.31491,395.06909Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  <path d="M445.03056,395.06909H419.962a2.50734,2.50734,0,0,1-2.56052-2.44431V312.12a2.50734,2.50734,0,0,1,2.56052-2.44431h25.06855a2.50734,2.50734,0,0,1,2.56051,2.44431v80.50475A2.50734,2.50734,0,0,1,445.03056,395.06909Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
                  <path d="M490.7462,395.06909H465.67765a2.56336,2.56336,0,0,1-2.56051-2.5603V288.94692a2.56336,2.56336,0,0,1,2.56051-2.5603H490.7462a2.56336,2.56336,0,0,1,2.56051,2.5603V392.50879A2.56336,2.56336,0,0,1,490.7462,395.06909Z" transform="translate(-128.72638 -134.28048)" fill="#364f6b" />
